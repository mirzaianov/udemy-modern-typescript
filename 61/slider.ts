...
type ISliderOptions = Omit<ISlider, 'speed' | 'animationName'> & {
  speed: number;
};
type IRequiredSliderOptions = Required<ISliderOptions>;

const customSliderOptions: IRequiredSliderOptions = {
  container: 'id',
  numberOfSlides: 4,
  speed: 1100,
  direction: 'horizontal',
